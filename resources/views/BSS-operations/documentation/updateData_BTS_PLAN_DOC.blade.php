...
@section('breadcrump')
    ...
    <li class="current breadcrumb-item" aria-current="page"><u style="margin-left: 6px;font-style: italic">BTS PLAN documentation</u></li>
    <a href="{{ url('nokia-update-data-bts') }}">
    ...
    <div class="panel panel-default" style="margin-bottom: 7%">
        <div style="text-align: center; text-transform: uppercase; font-size: 1.5em; font-weight: bold;">
            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled tooltip">
                BTS PLAN documentation
            </span>
        </div>
        <div class="container-fluid">
            <blockquote>
                <strong>BTS PLAN</strong> update just requires updating the file
