...
@section('breadcrump')
    ...
    <li class="current breadcrumb-item" aria-current="page">Update data of <u style="margin-left: 6px;font-style: italic"> BTS IP PLANNING on sheet NODE B PLAN</u></li>
...
@section('content')
    ...
    <div style="margin-left:-18px;width: 30px" class="container-fluid">
        <div class="container bg-light mt-0" style="height: 200px;position: fixed;">
            ...
            <div class="card-body">
                <form action="{{ route('nokia-update-data-nodeb') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                    ...
                    <a href="{{ url('nokia-update-data-nodeb-doc') }}">
