...
@section('breadcrump')
    ...
    <li class="current breadcrumb-item" aria-current="page">xml<u style="margin-left: 6px;font-style: italic">FSME</u></li>
...
@section('content')
    <div style="margin:auto" class="container">
        <form style="width: 100%; margin-left:35px;margin-top:15px" method="post" action="{{ route('nokia3g-xml-FSME')}}" enctype="multipart/form-data">
...
{{--                </div>--}}
                ...
                <div style="padding-to: 32px" class="form-group col-md-2">
                    <a href="{{ url('nokia3g-xml-FSME-documentation') }}">
    ...
    <div class="panel panel-default" style="margin-bottom: 65px">
...
{{--                </table>--}}
                ...
                <div class="panel-heading">
                    <h3 class="panel-title">Data retrieved from BTS IP Planning(NodeB Plan Sheet)</h3>
                </div>
                <div class="">
                    <div class="row">
                        ...
                        <div class="col-md-2.5">
                            <span class="trx">
                                <a href="{{ url('nokia3g-xml-FSME_generated') }}">
                        ...
                        <div class="col-md-2.5">
                            <span class="trx">
                                <a href="{{ url('nokia3g-xml-FSME_download') }}">
                                    <button style="margin-left: 45px; margin-top: 10px" type="button" class="btn btn-danger">
                                        DOWNLOAD xml FSME File <i style="margin-left: 5px" class="fa fa-hourglass-end" aria-hidden="true"></i>
                                    </button>
                                </a>
                            </span>
                        </div>
