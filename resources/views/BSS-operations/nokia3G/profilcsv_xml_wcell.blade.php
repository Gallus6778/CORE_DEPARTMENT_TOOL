...
@section('breadcrump')
    ...
    <li class="current breadcrumb-item" aria-current="page">Profil Csv for<u style="margin-left: 6px;font-style: italic">WCELL</u></li>
@endsection

@section('content')
    <div style="margin:auto" class="container-fluid">
        <form style="width: 100%; margin-left:35px;margin-top:15px" method="post" action="{{ route('nokia3g-profil-wbts')}}" enctype="multipart/form-data">
            ...
            <div class="form-row" style="margin: auto;width: 1200px">
                ...
                <div class="col-md-2.5">
                    <span class="trx">
                        <a href="{{ url('nokia3g-profil-wbts-download') }}">
                            <button style="margin-top: 31px" type="button" class="btn btn-danger">
