...
@section('breadcrump')
    ...
    <li class="current breadcrumb-item" aria-current="page">Update data for <u style="margin-left: 6px;font-style: italic"> CDD 3G </u></li>
@endsection
@section('content')
    ...
    <div style="margin-left:-18px;width: 1300px" class="container-fluid">
        <div class="container bg-light mt-0" style="height: 200px;">
            ...
            <div class="card-body">
                <form action="{{ route('huawei3g-cdd3g-update') }}" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
