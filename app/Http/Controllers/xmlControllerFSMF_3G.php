...
class xmlControllerFSMF_3G extends Controller
{
    public function xmlFMSFIndex(){
        $ligne = DB::table('updatedatanodebplan')->paginate(10);
        return view('BSS-operations.nokia3G.xml-nokia3G-FSMF',compact('ligne'));
    }

    public function xmlFMSFStore(Request $req){
...
//        dd($npgep_gw);
    ...
    public function xmlFSMFGenerated(){
...
<header>
<log action="created" appInfo="Flexi TRS Manager" appVersion="8.0.1035" dateTime="2017-01-10T14:19:36" user="BTSSM"/>
</header>
<managedObject class="FTM" distName="WBTS-' . $wbts . '/FTM-1" operation="update" version="WN8.0">
<p name="systemTitle">' . $siteTitle . '</p>
<p name="softwareReleaseVersion">FTM_R3_WN80_414.02</p>
...
<p name="unitTypeActual">FSM</p>
<p name="unitTypeExpected">FSM</p>
<p name="enableRP301Interface">false</p>
</managedObject>
<managedObject class="ETHLK" distName="WBTS-' . $wbts . '/FTM-1/ETHLK-0-1" operation="update" version="WN8.0">
...
<managedObject class="ETHLK" distName="WBTS-' . $wbts . '/FTM-1/ETHLK-0-2" operation="update" version="WN8.0">
...
<managedObject class="STPORT" distName="WBTS-' . $wbts . '/FTM-1/RSTP-1/STPORT-0-1" operation="update" version="WN8.0">
<p name="portPriority">128</p>
<p name="portNumber">1</p>
<p name="portPathCost">20000</p>
<p name="disableStpParticipation">true</p>
</managedObject>
<managedObject class="STPORT" distName="WBTS-1000/FTM-1/RSTP-1/STPORT-0-2" operation="update" version="WN8.0">
<p name="portPriority">128</p>
<p name="portNumber">2</p>
<p name="portPathCost">20000</p>
<p name="disableStpParticipation">true</p>
</managedObject>
<managedObject class="SYNC" distName="WBTS-WBTS_i' . $wbts . 'd_value/FTM-1/SYNC-1" operation="update" version="WN8.0"/>
...
<p name="sPlaneIpAddress">' . $uPlaneIpAddress . '</p>
...
<p name="cacCommittedBitRate">88500</p>
<p name="minSCTPPort">49152</p>
<p name="dcnCommittedBitRate">500</p>
...
<p name="administrativeState">locked</p>
<p name="destIpAddress">' . $npgepIpAddress . '</p>
<p name="destPort">7</p>
<p name="dscp">46</p>
<p name="messageSize">100</p>
<p name="plrAlarmThreshold">100</p>
<p name="rttAlarmThreshold">1000000</p>
<p name="sourceIpAddress">' . $uPlaneIpAddress . '</p>
</managedObject>
...
';
    ...
    public function xmlFSMFDownload(){
        $sitenamefsme = DB::table('sitenamefsme')->get();
        $name = null;
