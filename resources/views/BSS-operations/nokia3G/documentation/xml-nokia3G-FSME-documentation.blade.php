...
@section('breadcrump')
    ...
    <li class="current breadcrumb-item" aria-current="page"><u style="margin-left: 6px;font-style: italic">XML FSME documentation</u></li>
    ...
    <div class="panel panel-default" style="margin-bottom: 7%">
        <div style="text-align: center; text-transform: uppercase; font-size: 1.5em; font-weight: bold;">
            <span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="Disabled tooltip">
                XML FSME documentation
            </span>
        </div>
        <div class="container-fluid">
            <blockquote>
                <strong>XML FSME</strong> generation just requires updating the file
                ...
                <br><br>
                <i class="far fa-hand-point-right" style="margin-right: 20px;margin-left: 55px"></i><strong>Step 3 :</strong> Click on the <strong>Download static route file</strong> button, first , then on the <strong>Download xml FSME file</strong>.
